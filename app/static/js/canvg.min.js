!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
      ? (module.exports = e(require("rgbcolor"), require("stackblur-canvas")))
      : "function" == typeof define && define.amd
      ? define(["rgbcolor", "stackblur-canvas"], e)
    ...
    return (
      ...
      (function (t) {
        ...
        var f,
          p = function (t, e, i) {
            if (null != t || null != e || null != i) {
              var n = m(i || {});
              "string" == typeof t && (t = c.getElementById(t)),
                null != t.svg && t.svg.stop(),
                (t.childNodes &&
                  1 == t.childNodes.length &&
                  "OBJECT" == t.childNodes[0].nodeName) ||
                  (t.svg = n);
              ...
              for (var a = c.querySelectorAll("svg"), r = 0; r < a.length; r++) {
                var o = a[r],
                  h = c.createElement("canvas");
                if (void 0 !== o.clientWidth && void 0 !== o.clientHeight)
                  (h.width = o.clientWidth), (h.height = o.clientHeight);
                else {
        ...
        function m(s) {
          ...
          1 == D.opts.log &&
            ...
            (D.parseXml = function (e) {
              ...
              try {
                ...
                return (n = s.xmldom
                  ? new l.DOMParser(s.xmldom)
                  : new l.DOMParser()).parseFromString(e, "text/xml");
              }
            }),
          ...
          return (
            (D.Property.prototype.toTextBaseline = function () {
            ...
            (D.Font = new (function () {
              ...
              this.Parse = function (t) {
                for (
                  var e = {},
                    i = D.trim(D.compressSpaces(t || "")).split(" "),
                    n = {
                      fontSize: !1,
                      fontStyle: !1,
                      fontWeight: !1,
                  ...
                  n.fontStyle || -1 == r.Styles.indexOf(i[a])
                    ? n.fontVariant || -1 == r.Variants.indexOf(i[a])
                      ? n.fontWeight || -1 == r.Weights.indexOf(i[a])
                        ? n.fontSize
                          ? "inherit" != i[a] && (s += i[a])
                          : ("inherit" != i[a] &&
                              (e.fontSize = i[a].split("/")[0]),
                            (n.fontStyle =
                              n.fontVariant =
                              n.fontWeight =
                              n.fontSize =
                                !0))
                        : ("inherit" != i[a] && (e.fontWeight = i[a]),
                          (n.fontStyle = n.fontVariant = n.fontWeight = !0))
                      : ("inherit" != i[a] && (e.fontVariant = i[a]),
                        (n.fontStyle = n.fontVariant = !0))
                    : ("inherit" != i[a] && (e.fontStyle = i[a]),
                      (n.fontStyle = !0));
                ...
                (this.addBezierCurve = function (t, e, i, n, s, a, r, o) {
                  ...
                  for (var f = 0; f <= 1; f++) {
                    var p = function (t) {
                        return (
                          Math.pow(1 - t, 3) * h[f] +
                          3 * Math.pow(1 - t, 2) * t * l[f] +
                          3 * (1 - t) * Math.pow(t, 2) * u[f] +
                          Math.pow(t, 3) * c[f]
                        );
                      },
                    ...
                    if (0 != m) {
                      ...
                      if (!(v < 0)) {
                        ...
                        0 < g &&
                          g < 1 &&
                          (0 == f && this.addX(p(g)), 1 == f && this.addY(p(g)));
                        var x = (-d - Math.sqrt(v)) / (2 * m);
                        0 < x &&
                          x < 1 &&
                          (0 == f && this.addX(p(x)), 1 == f && this.addY(p(x)));
                      }
                    } else {
                      if (0 == d) continue;
                      var b = -y / d;
                      0 < b &&
                        b < 1 &&
                        (0 == f && this.addX(p(b)), 1 == f && this.addY(p(b)));
                    }
                  }
                }),
                (this.isPointInBox = function (t, e) {
                  return (
                    this.x1 <= t && t <= this.x2 && this.y1 <= e && e <= this.y2
                  );
                }),
                this.addPoint(t, e),
                this.addPoint(i, n);
            ...
            (D.Transform = function (t) {
              ...
              for (
                var i = D.trim(D.compressSpaces(t))
                    .replace(/\)([a-zA-Z])/g, ") $1")
                    .replace(/\)(\s?,\s?)/g, ") ")
                    .split(/\s(?=[a-z])/),
                  n = 0;
            ...
            (D.AspectRatio = function (t, e, i, n, s, a, r, o, h, l) {
              var u =
                  (e = (e = D.compressSpaces(e)).replace(/^defer\s/, "")).split(
                    " "
                  )[0] || "xMidYMid",
                c = e.split(" ")[1] || "meet",
                f = i / n,
              ...
              "meet" == c && ((n *= d), (a *= d)),
                "slice" == c && ((n *= m), (a *= m)),
                (h = new D.Property("refX", h)),
                (l = new D.Property("refY", l)),
                h.hasValue() && l.hasValue()
                  ? t.translate(-d * h.toPixels("x"), -d * l.toPixels("y"))
                  : (u.match(/^xMid/) &&
                      (("meet" == c && d == p) || ("slice" == c && m == p)) &&
                      t.translate(i / 2 - n / 2, 0),
                    u.match(/YMid$/) &&
                      (("meet" == c && d == f) || ("slice" == c && m == f)) &&
            ...
            (D.Element.ElementBase = function (a) {
              (this.attributes = {}),
                (this.styles = {}),
                ...
                (this.attribute = function (t, e) {
                  ...
                  return null != i
                    ? i
                    : (1 == e &&
                        ((i = new D.Property(t, "")), (this.attributes[t] = i)),
                      i || D.EmptyProperty);
                }),
                ...
                (this.style = function (t, e, i) {
                  ...
                  return (
                    1 == e && ((n = new D.Property(t, "")), (this.styles[t] = n)),
                    n || D.EmptyProperty
                  );
                }),
              ...
              if (null != a && 1 == a.nodeType) {
                ...
                this.attribute("id").hasValue() &&
                  null == D.Definitions[this.attribute("id").value] &&
                  (D.Definitions[this.attribute("id").value] = this);
                for (i = 0; i < a.childNodes.length; i++) {
                  ...
                  if (
                    ...
                    "" != D.compressSpaces(c) &&
                      this.addChild(new D.Element.tspan(u), !1);
                  }
                }
              }
            }),
                ...
                (this.setContext = function (t, e) {
                  if (!e) {
                    ...
                    if (this.style("fill-opacity").hasValue())
                      (n = (n = new D.Property("fill", t.fillStyle)).addOpacity(
                        this.style("fill-opacity")
                      )),
                        (t.fillStyle = n.value);
                    ...
                    if (
                      ...
                      this.style("paint-order").hasValue() &&
                        (t.paintOrder = this.style("paint-order").value),
                      this.style("stroke-dasharray").hasValue() &&
                        "none" != this.style("stroke-dasharray").value)
                    ) {
                      var r = D.ToNumberArray(
                      ...
                      void 0 !== t.lineDashOffset
                        ...
                        : void 0 !== t.mozDashOffset && (t.mozDashOffset = o);
                    }
                  }
                  if (void 0 !== t.font)
                  ...
                  this.style("transform", !1, !0).hasValue() &&
                    new D.Transform(this.style("transform", !1, !0).value).apply(
                      t
                    );
            ...
            (D.Element.RenderedElementBase.prototype =
              new D.Element.ElementBase()),
                ...
                (this.renderChildren = function (t) {
                  ...
                  if (null != e) {
                    if (this.style("marker-start").isUrlDefinition())
                      (i = this.style("marker-start").getDefinition()).render(
                        t,
                        e[0][0],
                        e[0][1]
                      );
                    ...
                    if (this.style("marker-end").isUrlDefinition())
                      (i = this.style("marker-end").getDefinition()).render(
                        t,
                        e[e.length - 1][0],
                        e[e.length - 1][1]
                      );
            ...
            (D.Element.PathElementBase.prototype =
              new D.Element.RenderedElementBase()),
              ...
              (this.base = D.Element.RenderedElementBase),
                ...
                (this.setContext = function (t) {
                  if (
                    ...
                    t.canvas.style &&
                      void 0 !== t.font &&
                      void 0 !== l.getComputedStyle)
                  ) {
                    t.font = l
                      .getComputedStyle(t.canvas)
                      .getPropertyValue("font");
                    var e = new D.Property(
                      "fontSize",
                      D.Font.Parse(t.font).fontSize
                    );
                ...
                (this.path = function (t) {
                  ...
                  return (
                    null != t &&
                      ...
                      t.closePath()),
                    new D.BoundingBox(s - i, a - n, s + i, a + n)
                  );
                });
            }),
                      ...
                      case "c":
                        for (; !e.isCommandOrEnd(); ) {
                          ...
                          e.addMarker(l, h, o),
                            ...
                            null != t &&
                              t.bezierCurveTo(o.x, o.y, h.x, h.y, l.x, l.y);
                        }
                        break;
                      case "S":
                      case "s":
                      ...
                      case "q":
                        for (; !e.isCommandOrEnd(); ) {
                          (r = e.current),
                            ...
                            (l = e.getAsCurrentPoint());
                          e.addMarker(l, h, h),
                            i.addQuadraticCurve(r.x, r.y, h.x, h.y, l.x, l.y),
                            null != t && t.quadraticCurveTo(h.x, h.y, l.x, l.y);
                        }
                        break;
                      case "T":
                      case "t":
                        ...
                        for (; !e.isCommandOrEnd(); ) {
                          ...
                          var u = e.getScalar(),
                            ...
                            m =
                              ((l = e.getAsCurrentPoint()),
                              new D.Point(
                                (Math.cos(f) * (r.x - l.x)) / 2 +
                                  (Math.sin(f) * (r.y - l.y)) / 2,
                                (-Math.sin(f) * (r.x - l.x)) / 2 +
                                  (Math.cos(f) * (r.y - l.y)) / 2
                              )),
                            y =
                              Math.pow(m.x, 2) / Math.pow(u, 2) +
                              Math.pow(m.y, 2) / Math.pow(c, 2);
                          1 < y && ((u *= Math.sqrt(y)), (c *= Math.sqrt(y)));
                          var v =
                            (p == d ? -1 : 1) *
                            Math.sqrt(
                              (Math.pow(u, 2) * Math.pow(c, 2) -
                                Math.pow(u, 2) * Math.pow(m.y, 2) -
                                Math.pow(c, 2) * Math.pow(m.x, 2)) /
                                (Math.pow(u, 2) * Math.pow(m.y, 2) +
                                  Math.pow(c, 2) * Math.pow(m.x, 2))
                            );
                          isNaN(v) && (v = 0);
                          ...
                          if (
                            (e.addMarkerAngle(V, S - (T * Math.PI) / 2),
                            e.addMarkerAngle(l, S - T * Math.PI),
                            i.addPoint(l.x, l.y),
                            null != t && !isNaN(w) && !isNaN(M))
                          ) {
                            P = c < u ? u : c;
                            var k = c < u ? 1 : u / c,
                              A = c < u ? c / u : 1;
              ...
              (this.base = D.Element.ElementBase),
                ...
                (this.createPattern = function (t, e, i) {
                  var n = this.attribute("width").toPixels("x", !0),
                    ...
                    a = new D.Element.svg();
                  (a.attributes.viewBox = new D.Property(
                    "viewBox",
                    this.attribute("viewBox").value
                  )),
                    (a.attributes.width = new D.Property("width", n + "px")),
                    (a.attributes.height = new D.Property("height", s + "px")),
                    (a.attributes.transform = new D.Property(
                      "transform",
                  ...
                  this.attribute("x").hasValue() &&
                    ...
                    i.hasValue()
                      ? (this.styles["fill-opacity"] = i)
                      : delete this.styles["fill-opacity"];
                  for (var h = -1; h <= 1; h++)
                    for (var l = -1; l <= 1; l++)
                      o.save(),
                        (a.attributes.x = new D.Property("x", h * r.width)),
                        (a.attributes.y = new D.Property("y", l * r.height)),
                        a.render(o),
                        o.restore();
              ...
              (this.base = D.Element.ElementBase),
                ...
                (this.render = function (t, e, i) {
                  if (e) {
                    ...
                    (n.attributes.viewBox = new D.Property(
                      "viewBox",
                      this.attribute("viewBox").value
                    )),
                      (n.attributes.refX = new D.Property(
                        "refX",
                        this.attribute("refX").value
                      )),
                      (n.attributes.refY = new D.Property(
                        "refY",
                        this.attribute("refY").value
                      )),
                      (n.attributes.width = new D.Property(
                        "width",
                        this.attribute("markerWidth").value
                      )),
                      (n.attributes.height = new D.Property(
                        "height",
                        this.attribute("markerHeight").value
                      )),
                      (n.attributes.fill = new D.Property(
                        "fill",
                        this.attribute("fill").valueOrDefault("black")
                      )),
                      (n.attributes.stroke = new D.Property(
                        "stroke",
            ...
            (D.Element.GradientBase = function (t) {
              ...
              (this.getGradient = function () {}),
                ...
                (this.createGradient = function (t, e, i) {
                  ...
                  var s = function (t) {
                      return i.hasValue()
                        ? new D.Property("color", t).addOpacity(i).value
                        : t;
                    },
                  ...
                  if (this.attribute("gradientTransform").hasValue()) {
                    ...
                    (h.attributes.x = new D.Property(
                      "x",
                      -D.MAX_VIRTUAL_PIXELS / 3
                    )),
                      (h.attributes.y = new D.Property(
                        "y",
                        -D.MAX_VIRTUAL_PIXELS / 3
                      )),
                      (h.attributes.width = new D.Property(
                        "width",
                        D.MAX_VIRTUAL_PIXELS
                      )),
                      (h.attributes.height = new D.Property(
                        "height",
                        D.MAX_VIRTUAL_PIXELS
                      ));
                    var l = new D.Element.g();
                    (l.attributes.transform = new D.Property(
                      "transform",
            ...
            (D.Element.animate = function (t) {
              (this.base = D.Element.AnimateBase),
                ...
                (this.calcValue = function () {
                  ...
                  return (
                    "%" === this.initialUnits && (e *= 100), e + this.initialUnits
                  );
                });
            }),
            ...
            (D.Element.animateTransform = function (t) {
              (this.base = D.Element.AnimateBase),
                ...
                (this.calcValue = function () {
                  for (
                    var t = this.progress(),
                      e = D.ToNumberArray(t.from.value),
                      i = D.ToNumberArray(t.to.value),
                      n = "",
                      s = 0;
                    s < e.length;
                    s++
            ...
            (D.Element.font = function (t) {
              ...
              for (var e = 0; e < this.children.length; e++) {
                var i = this.children[e];
                "font-face" == i.type
                  ? (this.fontFace = i).style("font-family").hasValue() &&
                    (D.Definitions[i.style("font-family").value] = this)
              ...
              (this.base = D.Element.RenderedElementBase),
                ...
                (this.renderChildren = function (t) {
                  ...
                  if (null == e)
                    ...
                    var i = this.parent
                        .style("font-size")
                        .numValueOrDefault(D.Font.Parse(D.ctx.font).fontSize),
                      n = this.parent
                        .style("font-style")
                        .valueOrDefault(D.Font.Parse(D.ctx.font).fontStyle),
                      s = this.getText();
                    e.isRTL && (s = s.split("").reverse().join(""));
                    for (
                      var a = D.ToNumberArray(this.parent.attribute("dx").value),
                        r = 0;
                      r < s.length;
                      r++
                    ) {
                      ...
                      (t.lineWidth = (t.lineWidth * e.fontFace.unitsPerEm) / i),
                        ...
                        (this.x +=
                          (i * (o.horizAdvX || e.horizAdvX)) /
                          e.fontFace.unitsPerEm),
                        void 0 === a[r] || isNaN(a[r]) || (this.x += a[r]);
                    }
                  }
                }),
                ...
                (this.measureText = function (t) {
                  ...
                  if (null != e) {
                    ...
                    for (
                      ...
                      (n +=
                        ((this.getGlyph(e, s, r).horizAdvX || e.horizAdvX) * i) /
                        e.fontFace.unitsPerEm),
                        void 0 === a[r] || isNaN(a[r]) || (n += a[r]);
                    }
                    return n;
                  }
            ...
            (D.Element.TextElementBase.prototype =
              new D.Element.RenderedElementBase()),
            (D.Element.tspan = function (t) {
              (this.captureTextNodes = !0),
                (this.base = D.Element.TextElementBase),
                this.base(t),
                (this.text = D.compressSpaces(
            ...
            (D.Element.a = function (t) {
              ...
              (this.text = this.hasText
                ? t.childNodes[0].value || t.childNodes[0].data
                : ""),
                (this.getText = function () {
                  return this.text;
                }),
                ...
                (this.renderChildren = function (t) {
                  if (this.hasText) {
                    ...
                    var e = new D.Property(
                      "fontSize",
                      D.Font.Parse(D.ctx.font).fontSize
                    );
                    D.Mouse.checkBoundingBox(
                      this,
                      new D.BoundingBox(
                        this.x,
                        this.y - e.toPixels("y"),
            ...
            (D.Element.textPath = function (t) {
              ...
              (this.text = D.compressSpaces(
                ...
                (this.renderChildren = function (t) {
                  ...
                  for (var a = 0; a < n.length; a++) {
                    ...
                    t.save(),
                      ...
                      "" != t.fillStyle && t.fillText(D.compressSpaces(h), 0, 0),
                      "" != t.strokeStyle &&
                        t.strokeText(D.compressSpaces(h), 0, 0),
                      t.restore(),
                      "underline" === e &&
                        (0 === a && t.moveTo(r.x, r.y + i / 8),
                ...
                (this.measureText = function (t, e) {
                  ...
                  if (((e = e || this.getText()), null != i)) {
                    ...
                    for (
                      ...
                      (s +=
                        ((this.getGlyph(i, e, r).horizAdvX || i.horizAdvX) * n) /
                        i.fontFace.unitsPerEm),
                        void 0 === a[r] || isNaN(a[r]) || (s += a[r]);
                    }
                    return s;
                  }
                ...
                (this.setTextData = function (r) {
                  if (!this.hasOwnProperty("glyphInfo")) {
                    var o = this,
                      ...
                      e = D.ToNumberArray(
                        this.parent.attribute("dx").valueOrDefault("0")
                      ),
                      i = 0,
                      l = this.parent
                        .style("text-anchor")
                    ...
                    var f = this.getPathLength(),
                      ...
                      d = 0;
                    ("middle" !== l && "center" !== l) || (d = -c / 2),
                      ("end" !== l && "right" !== l) || (d = -c),
                      (d += p);
                    var m = function (t, e) {
                      var i,
                        n = o.measureText(r, t);
                      " " === t && "justify" === l && c < f && (n += (f - c) / h),
                        -1 < e &&
                          (d +=
                            ((i = (i = e) || 0), o.letterSpacingCache[i] || 0));
                  ...
                  for (i.reset(); !i.isEnd(); ) {
                    ...
                    switch (i.command) {
                      ...
                      case "m":
                        ...
                        for (
                          n.push(h.x, h.y), i.start = i.current;
                          !i.isCommandOrEnd();
                      ...
                      case "h":
                        for (; !i.isCommandOrEnd(); ) {
                          var l = new D.Point(
                            (i.isRelativeCommand() ? i.current.x : 0) +
                              i.getScalar(),
                            i.current.y
                          );
                      ...
                      case "v":
                        for (; !i.isCommandOrEnd(); ) {
                          l = new D.Point(
                            i.current.x,
                            (i.isRelativeCommand() ? i.current.y : 0) +
                              i.getScalar()
                          );
                          n.push(l.x, l.y), (i.current = l);
                        }
                        ...
                        for (; !i.isCommandOrEnd(); ) {
                          var p = i.current,
                            ...
                            x =
                              ((f = i.getAsCurrentPoint()),
                              new D.Point(
                                (Math.cos(y) * (p.x - f.x)) / 2 +
                                  (Math.sin(y) * (p.y - f.y)) / 2,
                                (-Math.sin(y) * (p.x - f.x)) / 2 +
                                  (Math.cos(y) * (p.y - f.y)) / 2
                              )),
                            b =
                              Math.pow(x.x, 2) / Math.pow(d, 2) +
                              Math.pow(x.y, 2) / Math.pow(m, 2);
                          1 < b && ((d *= Math.sqrt(b)), (m *= Math.sqrt(b)));
                          var P =
                            (v == g ? -1 : 1) *
                            Math.sqrt(
                              (Math.pow(d, 2) * Math.pow(m, 2) -
                                Math.pow(d, 2) * Math.pow(x.y, 2) -
                                Math.pow(m, 2) * Math.pow(x.x, 2)) /
                                (Math.pow(d, 2) * Math.pow(x.y, 2) +
                                  Math.pow(m, 2) * Math.pow(x.x, 2))
                            );
                          isNaN(P) && (P = 0);
                ...
                (this.getPathLength = function () {
                  if (
                    void 0 === this.pathLength ||
                    null === this.pathLength ||
                    isNaN(this.pathLength)
                  )
                    for (
                      var t = (this.pathLength = 0);
                      t < this.dataArray.length;
                      t++
                    )
                      0 < this.dataArray[t].pathLength &&
                ...
                (this.getPointOnPath = function (t) {
                  ...
                  if (!(t < -5e-5 || i < t - 5e-5))
                    for (var s = 0; s < this.dataArray.length; s++) {
                      ...
                      if (
                        !a ||
                        !(a.pathLength < 5e-5 || e + a.pathLength + 5e-5 < t)
                      ) {
                        var r = t - e,
                          o = void 0;
                        switch (a.command) {
                ...
                (this.buildEquidistantCache = function (t, e) {
                  ...
                  if (
                    ...
                    !this.equidistantCache.hasOwnProperty("points") ||
                      this.equidistantCache.step != t ||
                      this.equidistantCache.precision != e)
                  ) {
                    this.equidistantCache = { step: t, precision: e, points: [] };
                    for (var n = 0, s = 0; s <= i; s += e) {
                      var a = this.getPointOnPath(s),
                        r = this.getPointOnPath(s + e);
                      void 0 !== a &&
                        void 0 !== r &&
                        t <= (n += this.getLineLength(a.x, a.y, r.x, r.y)) &&
                ...
                (this.getEquidistantPointOnPath = function (t, e, i) {
                  if (
                    (this.buildEquidistantCache(e, i),
                ...
                (this.getPointOnCubicBezier = function (
                  t,
                  e,
                  i,
                  n,
                ...
                (this.getPointOnEllipticalArc = function (t, e, i, n, s, a) {
                  var r = Math.cos(a),
                    ...
                    h = i * Math.cos(s),
                    l = n * Math.sin(s);
                  return { x: t + (h * r - l * o), y: e + (h * o + l * r) };
                }),
                  ...
                  switch (i) {
                    ...
                    case "C":
                      for (
                        ...
                        (r = this.getPointOnCubicBezier(
                          ...
                          (s += this.getLineLength(a.x, a.y, r.x, r.y)),
                          (a = r);
                      return s;
                    case "Q":
                      for (
                        ...
                        (r = this.getPointOnQuadraticBezier(
                          o,
                          t,
                          e,
                          n[0],
                    ...
                    case "A":
                      ...
                      if (
                        ...
                        for (o = h - c; u < o; o -= c)
                          (r = this.getPointOnEllipticalArc(
                            n[0],
                            n[1],
                            n[2],
                            n[3],
            ...
            (D.Element.image = function (t) {
              ...
              if ("" != e) {
                var a = e.match(/\.svg$/);
                if ((D.Images.push(this), (this.loaded = !1), a))
                  (this.img = D.ajax(e)), (this.loaded = !0);
                else {
                  (this.img = c.createElement("img")),
                  ...
                  0 != n &&
                    ...
                    a
                      ...
                      : (t.translate(e, i),
                        ...
                        r.loaded &&
                          (void 0 === this.img.complete || this.img.complete) &&
                  ...
                  for (
                    ...
                    if ("" != h) {
                      for (var l = D.Styles[h] || {}, u = 0; u < r.length; u++) {
                        ...
                        null != f &&
                          null != p &&
                          (l[D.trim(f)] = new D.Property(D.trim(f), D.trim(p)));
                      }
                      if (
                        ((D.Styles[h] = l),
                        (D.StylesSpecificity[h] = P(h)),
                        "@font-face" == h)
                      )
                        for (
                          var d = l["font-family"].value.replace(/"/g, ""),
                            m = l.src.value.split(","),
                            y = 0;
                          y < m.length;
                          y++
              ...
              (this.path = function (t) {
                ...
                (this.renderChildren = function (t) {
                  if (null != n) {
                    var e = n;
                    "symbol" == n.type &&
                      (((e = new D.Element.svg()).type = "svg"),
                      (e.attributes.viewBox = new D.Property(
                        "viewBox",
                        n.attribute("viewBox").value
                      )),
                      (e.attributes.preserveAspectRatio = new D.Property(
                        "preserveAspectRatio",
                        n.attribute("preserveAspectRatio").value
                      )),
                      (e.attributes.overflow = new D.Property(
                        "overflow",
                      ...
                      "svg" == e.type &&
                        (this.attribute("width").hasValue() &&
                          (e.attributes.width = new D.Property(
                            "width",
                            this.attribute("width").value
                          )),
                        this.attribute("height").hasValue() &&
                          (e.attributes.height = new D.Property(
                            "height",
              ...
              (this.base = D.Element.ElementBase),
                ...
                (this.apply = function (t) {
                  ...
                  for (var s = 0; s < this.children.length; s++) {
                    ...
                    if (void 0 !== a.path) {
                      var r =
                        void 0 !== a.elementTransform && a.elementTransform();
                      !r &&
                        a.style("transform", !1, !0).hasValue() &&
                        (r = new D.Transform(a.style("transform", !1, !0).value)),
                        r && r.apply(t),
                        a.path(t),
                  ...
                  n.call(t),
                    t.clip(),
                    e &&
                      ((CanvasRenderingContext2D.prototype.beginPath = i),
                ...
                (this.apply = function (t, e) {
                  ...
                  for (u = 0; u < this.children.length; u++)
                    "function" == typeof this.children[u].apply &&
                      this.children[u].apply(p, 0, 0, a + 2 * h, r + 2 * l);
                  t.drawImage(
                    f,
                    0,
                    0,
              ...
              this.apply = function (t, e, i, n, s) {
                ...
                for (i = 0; i < s; i++)
                  for (e = 0; e < n; e++) {
                    ...
                    v && ((u = c = f = 0), (p *= l / 255)),
                      m(a.data, e, i, n, 0, 0, u),
                      m(a.data, e, i, n, 0, 1, c),
                      m(a.data, e, i, n, 0, 2, f),
                      m(a.data, e, i, n, 0, 3, p);
                  }
            ...
            (D.Element.feGaussianBlur = function (t) {
              (this.base = D.Element.ElementBase),
                ...
                (this.apply = function (t, e, i, n, s) {
                  v && void 0 !== v.canvasRGBA
                    ? ((t.canvas.id = D.UniqueId()),
                      (t.canvas.style.display = "none"),
                      c.body.appendChild(t.canvas),
                      v.canvasRGBA(t.canvas, e, i, n, s, this.blurRadius),
                      c.body.removeChild(t.canvas))
                    : D.log(
            ...
            (D.CreateElement = function (t) {
              ...
              return (
                ((i =
                  void 0 !== D.Element[e]
                    ? new D.Element[e](t)
                    : new D.Element.MISSING(t)).type = t.nodeName),
                i
              );
            }),
            (D.load = function (t, e) {
            ...
            (D.loadXmlDoc = function (a, r) {
              ...
              var i = function (t) {
                for (var e = a.canvas; e; )
                  (t.x -= e.offsetLeft),
                    ...
                    (e = e.offsetParent);
                return (
                  l.scrollX && (t.x += l.scrollX),
                  l.scrollY && (t.y += l.scrollY),
                  t
                );
              };
              1 != D.opts.ignoreMouse &&
                ((a.canvas.onclick = function (t) {
                  var e = i(
                    new D.Point(
              ...
              var h = !0,
                n = function () {
                  D.ViewPort.Clear(),
                    a.canvas.parentNode
                      ? D.ViewPort.SetCurrent(
                          a.canvas.parentNode.clientWidth,
                          a.canvas.parentNode.clientHeight
                        )
                      : D.ViewPort.SetCurrent(800, 600),
                    1 != D.opts.ignoreDimensions &&
                      (h ||
                        (null == D.opts.scaleWidth &&
                          null == D.opts.scaleHeight)) &&
                      (o.style("width").hasValue() &&
                        ((a.canvas.width = o.style("width").toPixels("x")),
                        a.canvas.style &&
                          (a.canvas.style.width = a.canvas.width + "px")),
                      o.style("height").hasValue() &&
                        ((a.canvas.height = o.style("height").toPixels("y")),
                        a.canvas.style &&
                  ...
                  if (
                    (1 == D.opts.ignoreDimensions &&
                      o.style("width").hasValue() &&
                      o.style("height").hasValue() &&
                      ((t = o.style("width").toPixels("x")),
                      (e = o.style("height").toPixels("y"))),
                    D.ViewPort.SetCurrent(t, e),
                    null != D.opts.offsetX &&
                      (o.attribute("x", !0).value = D.opts.offsetX),
                    null != D.opts.offsetY &&
                      (o.attribute("y", !0).value = D.opts.offsetY),
                    ...
                    null != D.opts.scaleWidth &&
                      (o.attribute("width").hasValue()
                        ? (i =
                            o.attribute("width").toPixels("x") /
                            D.opts.scaleWidth)
                        : isNaN(s[2]) || (i = s[2] / D.opts.scaleWidth)),
                      null != D.opts.scaleHeight &&
                        (o.attribute("height").hasValue()
                          ? (n =
                              o.attribute("height").toPixels("y") /
                              D.opts.scaleHeight)
                          : isNaN(s[3]) || (n = s[3] / D.opts.scaleHeight)),
                      null == i && (i = n),
                      null == n && (n = i),
                      (o.attribute("width", !0).value = D.opts.scaleWidth),
                      (o.attribute("height", !0).value = D.opts.scaleHeight),
                      (o.style("transform", !0, !0).value +=
                        " scale(" + 1 / i + "," + 1 / n + ")");
                  }
                  1 != D.opts.ignoreClear && a.clearRect(0, 0, t, e),
                    o.render(a),
                    h &&
                      ((h = !1),
                      "function" == typeof D.opts.renderCallback &&
                        D.opts.renderCallback(r));
                },
                s = !0;
              D.ImagesLoaded() && ((s = !1), n()),
                (D.intervalID = setInterval(function () {
                  var t = !1;
                  if (
                    (s && D.ImagesLoaded() && (t = !(s = !1)),
                  ...
                  "function" == typeof D.opts.forceRedraw &&
                    1 == D.opts.forceRedraw() &&
                    (t = !0),
                    t && (n(), D.Mouse.runEvents());
                }, 1e3 / D.FRAMERATE));
            }),
            (D.stop = function () {
